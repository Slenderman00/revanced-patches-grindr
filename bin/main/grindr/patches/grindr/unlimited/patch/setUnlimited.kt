...
import app.revanced.patches.grindr.unlockAlbums.patch.GetAlbumViewablePatch

import app.revanced.patches.grindr.Constants.trueBytecode
import app.revanced.patches.grindr.Constants.falseBytecode
...
@Patch(
    ...
    dependencies = [FirebaseGetCertPatchGrindr::class, GetAlbumViewablePatch::class],
    compatiblePackages = [
